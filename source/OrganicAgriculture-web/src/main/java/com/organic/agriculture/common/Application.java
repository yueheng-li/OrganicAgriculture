package com.organic.agriculture.common;
...
public class Application {
     ...
     * セッションユーザキー
     */
    public static String DEFAULT_SESSION_AUTH_DATA = "DEFAULT_SESSION_AUTH_DATA";
    public static String DEFAULT_SESSION_USER_DATA = "DEFAULT_SESSION_USER_DATA";
